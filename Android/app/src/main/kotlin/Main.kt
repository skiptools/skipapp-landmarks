...
internal val logger: SkipLogger = SkipLogger(subsystem = "landmarks", category = "Landmarks")

private typealias AppRootView = LandmarksRootView
private typealias AppDelegate = LandmarksAppDelegate
